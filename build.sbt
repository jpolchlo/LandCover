lazy val commonSettings = Seq(
  ...
  //fork in run := true,
  //javaOptions in run ++= Seq("-Xms512M", "-Xmx2G", "-XX:+UseConcMarkSweepGC"),
  scalacOptions ++= Seq(
    "-deprecation",
    "-unchecked",
    "-Yinline-warnings",
  ...
  libraryDependencies ++= Seq(
    "com.azavea.geotrellis"%% "geotrellis-spark-etl"  % "1.0.0-a00c35b",
...
lazy val root = Project("landcover", file("."))
  .settings(commonSettings: _*)
  .aggregate(common, demo, learning)
